...
//
// On Mon Apr 14 00:29:50 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkSimpleCounter(CLK,
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE) $display("Counter = %d", count);
    if (RST_N != `BSV_RESET_VALUE) if (count == 8'd10) $finish(32'd1);
  end
  // synopsys translate_on
